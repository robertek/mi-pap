...
int load_file( char * file )
{
	...
	poly_size = (ul_int*)calloc( sizeof(ul_int), 3 );
	poly = (ul_int**)calloc( sizeof(ul_int*), 3 );
	...
	for( num=0; num<2; num++ )
	{
		...
		poly[num] = (ul_int*)calloc( sizeof(ul_int), poly_size[num] );
	...
	poly[2] = (ul_int*)calloc( sizeof(ul_int), poly_size[2] + 1 );
